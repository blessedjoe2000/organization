...
import { getRandomProverb } from "@/app/generateRandom";
...
export default function Proverbs({ initialProverb }) {
  const proverbs = [
    {
      ...
      value: "Ose ii gba ni usẹnbhokhan.",
      englishProver: "English proverb- meaning:",
      englishValue: "A young man's beauty is never without defects.",
    },
    {
      esanProverb: "Esan adage - itanh:",
      value: "Eji Aah nyẹlẹn ọhle Aah khọ.",
      englishProverb: "English proverb- meaning:",
      englishValue: " People resemble where they live.",
    },
    {
      esanProverb: "Esan adage - itanh:",
      value: "Udo ni Aah daghe ọ' vade ii degbi ọrhia bhi ẹlo.",
      englishProverb: "English proverb- meaning:",
      englishValue: " A missile that one sees coming does not blind one.",
    },
    {
      esanProverb: "Esan adage - itanh:",
      value: "Eji ọboh da gui otọ ọhle ọle da horiẹ.",
      englishProverb: "English proverb- meaning:",
      englishValue: " A native doctor disappears only where he is used to.",
    },
    {
      esanProverb: "Esan adage - itanh:",
      value: "Aah ii ri ebi Aah nanọ bui awa re.",
      englishProverb: "English proverb- meaning:",
      englishValue:
        " You don’t tempt a dog with something to lick,since dog is an avid licker.",
    },
    {
      esanProverb: "Esan adage - itanh:",
      value:
      ...
      englishProverb: "English proverb- meaning:",
      englishValue: " Clothing a corpse is simply to beautify it.",
    },
    {
      esanProverb: "Esan adage - itanh:",
    ...
    {
      esanProverb: "Esan adage - itanh:",
      value: "Amẹn ni ọrhia la muọn ii gbera ọle a.",
      englishProverb: "English proverb- meaning:",
      englishValue: " The water one would drink can never flow past one.",
    },
    {
      esanProverb: "Esan adage - itanh:",
    ...
    {
      esanProverb: "Esan adage - itanh:",
      value: "Ọmọn nọ yyu ọle mhọn ose nẹ.",
      englishProverb: "English proverb- meaning:",
      englishValue: " It is the deceased child that is always the prettiest.",
    },
    {
      esanProverb: "Esan adage - itanh:",
    ...
    {
      esanProverb: "Esan adage - itanh:",
      value: "Oẹ ọkpọkpa Aah zẹ bhi okọ-ẹdin.",
      englishProverb: "English proverb- meaning:",
      englishValue: " In a palm oil dish, you take one step at a time.",
    },
    {
      esanProverb: "Esan adage - itanh:",
    ...
    {
      esanProverb: "Esan adage - itanh:",
      value: "Ose ba ni emiamhẹn.",
      englishProverb: "English proverb- meaning:",
      englishValue: " Beauty is more painful than infirmity.",
    },
    {
      esanProverb: "Esan adage - itanh:",
    ...
    {
      esanProverb: "Esan adage - itanh:",
      value: "Ure kha lo bhi ẹbọ, ọ’ ki khin ẹbọ.",
      englishProverb: "English proverb- meaning:",
      englishValue: " When a snail inhabits a shrine, it becomes an idol.",
    },
  ];
  ...
  const [currentProverb, setCurrentProverb] = useState(
    initialProverb || getRandomProverb(proverbs)
  );
  ...
  return (
    <div>
      <div>
        <h3>{currentProverb.esanProverb}</h3>
        <p>{currentProverb.value}</p>
      </div>
      <div>
        <h3>{currentProverb.englishProverb}</h3>
        <p>{currentProverb.englishValue}</p>
      </div>
      <div>
        <p>{author}</p>
      </div>
